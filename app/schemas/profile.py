...
PROFILE_TOOL_SCHEMA = {
    "name": "update_profile",
    "description": (
        "Record the facts about the candidate that were explicitly stated in the "
        "conversation so far. Only include a field if the user actually said it — "
        "never guess or infer a value that wasn't stated."
    ),
    "input_schema": {
        "type": "object",
        "properties": {
        ...
        "required": ["profile", "reply_to_user", "ready_for_confirmation"],
    },
}
