...
не створює дублікати. Для детермінованого зіставлення використовуються
канонічні назви `mnp_skills` і активні синоніми `mnp_skill_aliases`;
неоднозначні чи невідомі фрази не стають пошуковими тегами автоматично.
Інші AI-пропозиції не записуються в профіль.
